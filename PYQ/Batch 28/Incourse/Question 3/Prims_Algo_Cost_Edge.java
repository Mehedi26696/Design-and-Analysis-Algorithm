...
public class Prims_Algo_Cost_Edge {
    ...
    static void primsAlgo(ArrayList<Edge> graph[]) {
        ...
        char [] st = {'a','b','c','d','e','f','g','h','i'}; // Array to map vertex numbers to characters
        ...
        for (Edge edge : mst) {
         ...
         //   System.out.println("From " + edge.src + " to " + edge.dest + " with weight " + edge.weight);
            ...
            System.out.println("From " + st[edge.src] + " to " + st[edge.dest] + " with weight " + edge.weight); // Print the edges with character mapping
        }
